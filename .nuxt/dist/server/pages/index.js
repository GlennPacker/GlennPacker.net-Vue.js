...
module.exports = __webpack_require__.p + "img/GlennPacker.2e06e76.jpg";
...
// Module
exports.push([module.i, ".image-circle{border-radius:50%;max-width:390px;width:100%}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=48a355fb&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"layout":"","fluid":""}},[_c('v-flex',{attrs:{"md4":"","hidden-md-and-down":"","pr-5":"","pl-5":"","pt-5":""}},[_c('img',{staticClass:"image-circle",attrs:{"src":__webpack_require__(161)}})]),_vm._v(" "),_c('v-flex',{attrs:{"md12":"","pt-5":""}},[_c('p',[_vm._v("Glenn Packer is a freelance contractor, working as a full-stack developer with experience in many different sectors and technologies including Vue JS.")]),_vm._v(" "),_c('p',[_vm._v("Based in Sussex, Glenn is available for any length of contract, anywhere in the UK or Europe.")]),_vm._v(" "),_c('p',[_vm._v("Glenn Packer can bring a wealth of knowledge and expertise to a project, either to kickstart a new one or bring new ideas to the environment.")]),_vm._v(" "),_c('p',[_vm._v("Happy to work either in an Agile or Waterfall environment.")]),_vm._v(" "),_c('p',[_vm._v("This website is a demo of a site using the Nuxt and Vue.js frameworks with material design (Vuetify) and is dedicated to the subject. Glenn first used the Vue Js framework while in contract for Lumesse in April 2017")]),_vm._v(" "),_c('p',[_vm._v("\n      To see the general website please visit\n      "),_c('a',{attrs:{"href":"//glennpacker.net","target":"new"}},[_vm._v("GlennPacker.net")])]),_vm._v(" "),_c('blockquote',{staticClass:"blockquote padding-top-xl"},[_c('p',[_vm._v("\"Vue provides an answer to the issue of JavaScript fatigue, and it is a worthy successor to the legacy of jQuery\"")]),_vm._v(" "),_c('footer',[_vm._v("Peter Jang - Dean of instruction at Actualize")])])])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=48a355fb&
