...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/contact.vue?vue&type=template&id=04ea6502&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',[_c('h3',[_vm._v("Contact Glenn")]),_vm._v(" "),(!_vm.sent)?_c('div',[_c('form',{attrs:{"name":"contactForm"},on:{"submit":function($event){$event.preventDefault();return _vm.handleSubmit($event)}}},[_c('transition',{attrs:{"name":"post-message-animation","enter-active-class":"animated flipInX","leave-active-class":"animated flipOutX"}},[(_vm.message && _vm.message.text)?_c('div',[_c('div',{staticClass:"alert",class:{'alert-success': _vm.message.type === 'success'},attrs:{"role":"alert"}},[_vm._v(_vm._s(_vm.message.text))])]):_vm._e()]),_vm._v(" "),(_vm.message.type === 'error')?_c('transition',{attrs:{"name":"error-animation","enter-active-class":"animated flipInX","leave-active-class":"animated flipOutX"}},[_c('div',{staticClass:"alert alert-danger",attrs:{"role":"alert"}},[_c('strong',[_vm._v("Doh!")]),_vm._v("\n          "+_vm._s(_vm.message.text)+"\n        ")])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"col-md-12"},[_c('v-text-field',{directives:[{name:"validate",rawName:"v-validate"}],staticClass:"form-control",attrs:{"label":"Name","type":"text","id":"name","data-vv-rules":"required","data-vv-as":"Name","name":"name","placeholder":"name"},model:{value:(_vm.contact.Name),callback:function ($$v) {_vm.$set(_vm.contact, "Name", $$v)},expression:"contact.Name"}}),_vm._v(" "),_c('v-text-field',{directives:[{name:"validate",rawName:"v-validate"}],attrs:{"label":"Email Address","type":"email","id":"from","data-vv-rules":"required","data-vv-as":"Email","name":"from","placeholder":"email address"},model:{value:(_vm.contact.Email),callback:function ($$v) {_vm.$set(_vm.contact, "Email", $$v)},expression:"contact.Email"}}),_vm._v(" "),_c('v-textarea',{directives:[{name:"validate",rawName:"v-validate"}],attrs:{"label":"Message","palceholder":"message","id":"message","data-vv-rules":"required","data-vv-as":"Message","name":"message"},model:{value:(_vm.contact.Message),callback:function ($$v) {_vm.$set(_vm.contact, "Message", $$v)},expression:"contact.Message"}}),_vm._v(" "),_c('v-btn',{attrs:{"color":"primary","type":"submit"}},[_vm._v("Send")])],1)],1),_vm._v(" "),_c('v-snackbar',{attrs:{"multi-line":true,"right":true,"timeout":3000,"top":true,"color":_vm.message.type},model:{value:(_vm.showSnak),callback:function ($$v) {_vm.showSnak=$$v},expression:"showSnak"}},[_vm._v(_vm._s(_vm.message.text))])],1):_vm._e(),_vm._v(" "),(_vm.sent)?_c('div',[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-md-4"},[_c('img',{staticClass:"circleimage",attrs:{"src":"/images/GlennPacker.jpg"}})]),_vm._v(" "),_c('div',{staticClass:"col-md-4"},[_c('p',[_vm._v("Thanks for contacting us.")]),_vm._v(" "),_c('p',[_vm._v("We will get back to you as soon as we can.")])]),_vm._v(" "),_c('div',{staticClass:"col-md-4 text-right"},[_c('img',{staticClass:"circleimage",attrs:{"src":"/images/cat-waiting-for-the-mail.jpg"}})])])]):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/contact.vue?vue&type=template&id=04ea6502&
...
/* harmony default export */ var contactvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async sendContact() {
      try {
        await this.$axios.$post("http://glennpacker.net/api/contact", this.contact);
        this.message = {
          type: "success",
          text: "Message Sent!"
        };
...
var VSnackbar = __webpack_require__(157);
...
var VTextarea = __webpack_require__(159);
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VContainer: VContainer["a" /* default */],VSnackbar: VSnackbar_VSnackbar,VTextField: VTextField["a" /* default */],VTextarea: VTextarea_VTextarea})
